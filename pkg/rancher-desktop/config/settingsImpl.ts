...
let migratedSettingsFileLocationOnWindows = false;
...
function migrateSettingsLocationOnWindows(): boolean {
  if (migratedSettingsFileLocationOnWindows || process.platform !== 'win32') {
    return false;
  }
  ...
  try {
    ...
    migratedSettingsFileLocationOnWindows = true;
